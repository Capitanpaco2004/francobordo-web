...
{
var val;
val = "<?php echo HTTP_CATALOG_SERVER . DIR_WS_CATALOG . "export_cdbarcos.php?format="; ?>";
...
?>
              ...
              <tr>
                <td class="main"><?php echo COMPARATEUR_CODE; ?><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?><?php echo tep_draw_input_field('p', "Ciao0908", 'onblur ="affiche()"'); ?></td>
                </tr>
              <tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>

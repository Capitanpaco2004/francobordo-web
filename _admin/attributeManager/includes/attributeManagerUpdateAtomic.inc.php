	...
	foreach(${AM_SESSION_VAR_NAME} as $newAttribute) {
		...
		$newAttributeData = array(
			...
			'options_id' => amDB::input($newAttribute['option_id']),
        		...
        		'reference' => amDB::input($newAttribute['reference']),	
				'reference_prov' => amDB::input($newAttribute['reference_prov']),	
				'products_attributes_ean' => amDB::input($newAttribute['products_attributes_ean']),

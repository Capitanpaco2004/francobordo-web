    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><h3>Exportar Pedidos</h3></td>
          </tr>
  ...
  <tr>
    <td>
        <table border="0" cellpadding="0">
          <tr>
            <td class="main"><?php echo "Desde el Pedido #:"; ?></td>
            <td><input name="start" size="5" value="<?php echo $start; ?>">
          </tr>
          <tr>
            <td class="main"><?php echo "Hasta el Pedido #:" ; ?></td>
            <td><input name="end" size="5" value="<?php echo $end; ?>">
          </tr>
          <tr>
            <td class="main"><?php echo "Estado de los pedidos:"; ?></td>
            <?php
...
?>
            <td><?php echo tep_draw_pull_down_menu('status', array_merge(array(array('id' => '', 'text' => 'Todos')), $orders_statuses), $status); ?> 
          </tr>
          <tr>
            <td class="main"><?php echo "Formato:"; ?></td>
            <td><select name="submitted">
                <option value="1">Crear CSV</option>

                <option value="2">Imprimir en pantalla</option>
              </select>
            </td>
          </tr>
          <tr>
...
if($submitted == 2){ // Html output to screen
	...
	$csv_output .= "<td width=50>Fecha".$delim;
...
$csv_output .= $open_header;
if($submitted == 2){ // Html output to screen
	$csv_output .= "<td width=100>Modelo".$delim;
	$csv_output .= "<td width=25>Cantidad".$delim;
	$csv_output .= "<td width=250>Producto".$delim;
	$csv_output .= "<td width=200>Comentarios".$delim;
}
$csv_output .= $close_header;

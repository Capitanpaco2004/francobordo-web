...
?>
          <tr class="dataTableRow">
			...
			<td class="main"><?php echo file_exists($feeds_location_fs . $feed['filename']) ? '<a href="' . $feeds_location_web . $feed['filename'] . '" target="_blank">' . tep_image(DIR_WS_ICONS . 'preview.png', ICON_PREVIEW) . '</a>' : '&nbsp;'; ?></td>
...
?>
	  ...
	  <tr>
	    <td class="main" align="right"><?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?></td>
	  </tr>
      <tr>
        <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
      </tr>

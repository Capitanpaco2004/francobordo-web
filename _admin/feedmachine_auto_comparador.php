...
// Procesar SOLO la config "comparador.php" — no afectar al resto de feeds
$feeds = isset($feeds['comparador.php']) ? array('comparador.php' => $feeds['comparador.php']) : array();
...
$fmu = FM_SAVE_LOCATION . 'fm-info-comparador.txt';

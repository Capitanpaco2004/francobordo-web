...
$feed_config = [
	...
	'fields'                      => [
		...
		'price'                   => [
			'output' => 'FM_RS_final_price_with_TAX_comparador',
			'type'   => 'FUNCTION',
		],
		'cost_price'              => [
		...
		'google_product_category' => [
			'output' => 'FM_RS_google_categories_comparador', //change the name to the name used for the function
			'type'   => 'FUNCTION',
		],
		'product_type'            => [
		...
		'pdf_url'                 => [
			'output' => 'FM_RS_pdf_url_comparador',
			'type'   => 'FUNCTION',
		],
		'file_url'                => [
			'output' => 'FM_RS_file_url_comparador',
			'type'   => 'FUNCTION',
		],
	],
...
function FM_RS_product_id_comparador($product) {
	return 'Francobordo' . $product['products_id'] . '_comparador';
}

function FM_RS_google_categories_comparador($product) {
...
function FM_RS_final_price_with_tax_comparador($product) {
...
function FM_RS_pdf_url_comparador($product) {
...
function FM_RS_file_url_comparador($product) {

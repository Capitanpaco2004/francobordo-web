...
<?php echo tep_admin_files_boxes('cex_envios.php', '<i class="bullet"></i> Env&iacute;os Correos Express'); ?>
<?php echo tep_admin_files_boxes('correos_envios.php', '<i class="bullet"></i> Env&iacute;os Correos'); ?>
<div>

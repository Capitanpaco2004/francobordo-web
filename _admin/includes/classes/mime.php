...
class mime {
	...
	function __construct(public $_body, $params = '') {
		if ($params == '') {
			$params = [];
		}
...
//    function &addSubPart($body, $params) {
	...
	function _getEncodedData($data, $encoding) {
		return match ($encoding) {
			'7bit'             => $data,
			'quoted-printable' => $this->_quotedPrintableEncode($data),
			'base64'           => rtrim(chunk_split(base64_encode((string)$data), 76, $this->lf)),
			default            => null,
		};
	}

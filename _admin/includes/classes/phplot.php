...
//Grid Formatting
	...
	// Propiedades asignadas en métodos (declaradas explícitamente para PHP 8.2+)
	public $background_done;
	public $data_count;
	public $data_group_space;
	public $i_dark;
	public $img;
	public $img_format;
	public $min_x;
	public $ndx_bg_color;
	public $ndx_grid_color;
	public $ndx_i_dark;
	public $ndx_i_light;
	public $ndx_label_color;
	public $ndx_light_grid_color;
	public $ndx_plot_bg_color;
	public $ndx_text_color;
	public $ndx_tick_color;
	public $ndx_title_color;
	public $output_file;
	public $plot_area_height;
	public $plot_origin_x;
	public $plot_origin_y;
	public $record_bar_width;
	public $records_per_group;
	public $rgb_array;
	public $title_font_height;
	public $title_font_width;
	public $x_label_height;
	public $x_tot_margin;
	public $xscale;
	public $y_tot_margin;
	public $yscale;
...
//////////////COLORS
	...
	function DrawHorizontalTicks() {
		...
		switch ($this->x_grid_label_type) {
			...
			case "time":  //Time formatting suggested by Marlin Viss
				$xlab = date($this->x_time_format,$this->plot_min_x);
			break;
			default:
		...
		while ($x_tmp <= $this->plot_max_x){
			...
			switch ($this->x_grid_label_type) {
				...
				break;
				case "time":  //Time formatting suggested by Marlin Viss
					$xlab = date($this->x_time_format,$x_tmp);
				break;
				default:
					//Unchanged from whatever format is passed in
					$xlab = $x_tmp;
	...
	function FormatYTickLabel($which_ylab) { 
		switch ($this->y_grid_label_type) {
			...
			break;
			case "time":
				$ylab = date($this->y_time_format,$which_ylab);
			break;
			case "right":

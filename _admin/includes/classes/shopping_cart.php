...
class shoppingCart
{
	...
	public $content_type, $any_out_of_stock, $hasModified, $uuid, $cg_id, $basket, $totalNoTax;
	public $cartID;
      ...
      foreach(array_keys($this->contents) as $products_id) {
        ...
        if ($products = tep_db_fetch_array($products_query)) {
          ...
          $products_array[] = array('id' => $products_id,
									...
									'ubicacion' => $products['products_ubicacion'],

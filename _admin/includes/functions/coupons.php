 ...
 */
  ...
  function kgt_draw_type_drop_down( $type = 'discount', $name = '', $default = '', $params = '' ) {
    if( $type == 'discount' ) {
      $values = array( array( 'id' => 'fixed', 'text' => 'Descuento Fijo' ),
                       array( 'id' => 'percent', 'text' => 'Descuento Porcentaje' ),
                       array( 'id' => 'shipping', 'text' => 'Descuento Envios' ) );
    } else if( $type == 'min_order' ) {
      $values = array( array( 'id' => 'price', 'text' => 'Precio Total' ),
                       array( 'id' => 'quantity', 'text' => 'Cantidad de Producto' ) );
    }

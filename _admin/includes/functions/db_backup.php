...
function osc_restore_from_file($time_to_stop_restore, $skip_query, $file = '', $file_offset = 0, $tables_to_restore = '', $restore_all_tables = 1, $remove_table_from_tables_to_restore = '') {
		// Desencriptamos contenido
		$sFile = $file;
		$sContent = file_get_contents( $sFile );		
		$fp = fopen( $sFile, "w+" );
		fwrite( $fp, tools::decrypt( $sContent ) );
		fclose( $fp );
...
// http://www.phphulp.nl/php/scripts/7/608/    

...
*/
define('HEADING_TITLE', 'Export urls');
...
define('COMPARATEUR_CHAMP', 'Free field, save for example <b><i>"?id=1"</i></b> to add this parameter in urls exported. No verification is done');
define('COMPARATEUR_URL', 'Url: ');
?>
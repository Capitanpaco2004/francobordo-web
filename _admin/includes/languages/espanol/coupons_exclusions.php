...
define('ERROR_DISCOUNT_COUPONS_SELECTED_LIST', 'Se ha producido un error en la determinaci&oacute;n de los ya excluidos '.$_GET['type'].'.');
define('ERROR_DISCOUNT_COUPONS_ALL_LIST', 'Se ha producido un error en la determinaci&oacute;n de la disponibilidad '.$_GET['type'].'.');

<?php
define('HEADING_TITLE', 'Panel de administración');
define('HEADING_INPUT_PLACEHOLDER_MAIL', 'Introduce tu email');
define('HEADING_INPUT_PLACEHOLDER_PASSWORD', 'Password');
define('TEXT_PASSWORD_FORGOTTEN', '¿Has olvidado tu contraseña?');
define('IMAGE_BUTTON_LOGIN', 'Acceder');
...
define('ENTRY_PASSWORD_NEW_ERROR', 'Su contraseña nueva debe tener al menos ' . (defined('ENTRY_PASSWORD_MIN_LENGTH') ? ENTRY_PASSWORD_MIN_LENGTH : 8) . ' letras, al menos una letra en mayúsculas, al menos una letra en minúsculas y al menos un número.');

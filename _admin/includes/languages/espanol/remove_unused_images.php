...
define('TEXT_LINE_135', '<b>ERROR - Additional Table &amp; Image field count do not match! (Lines 78 - 83 of <i>remove__unused_images.php</i>).</b>');
...
define('TEXT_LINE_280_1', '<hr>Images in the shop\'s DATABASE<br><b>The total number of images in the db is:&nbsp;');
define('TEXT_LINE_280_2', '<br><br>The database is being read as:<br>');
...
define('TEXT_LINE_318', '<hr><b>List of SERVER images</b><hr><b>The total number of images on the server is:&nbsp;');
define('TEXT_LINE_320', 'The following image folders has been read:');
...
define('TEXT_LINE_387', '<b>Moved Images that are not being called from the Database</b>');
...
define('TEXT_LINE_420', 'Click here to run the script again');
define('TEXT_LINE_427', 'Click Here to Move ALL Checked Images');
define('TEXT_LINE_428_1', '**CHECKED IMAGES will be MOVED**');
define('TEXT_LINE_428_2', 'NB: After clicking wait for the script response page.');
define('TEXT_LINE_429_1', '**IMPORTANT**');
define('TEXT_LINE_429', '**IMPORTANT**<br>The Images with Checked boxes will be moved to the <b>UNUSED</b>  directory, if they exist in a sub-directory, they will be moved to a sub-directory named <b>UNUSED</b>. So uncheck any images not listed in the database still used on the site\'s pages that have not been checked - otherwise they will be moved and will not show up on your site.<br><br>It is a good idea to check if these images before you proceed. The images name above are linked to the its image, you may click on them and review the image in a new opened window.<br><br>');
...
define('TEXT_LINE_430', '<b>FIRST AND FOREMOST:<br>ALWAYS BACKUP FIRST!</b>');

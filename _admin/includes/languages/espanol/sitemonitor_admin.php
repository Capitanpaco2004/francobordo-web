...
define('TEXT_HACK_EXPLAIN_FILE', '- The entry in the File column refers to the suspected hacked file. Click on it will display a popup displaying the contents of the file.');
...
define('ERROR_IMAGES_HAS_PHP', 'WARNING: Your images directory contains .php files but it should not.');
?>
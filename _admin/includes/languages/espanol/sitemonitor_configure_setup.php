...
Seup the Exclude list the way you want it, following the directions to the right of that section. Then 
...
define('TEXT_OPTION_EXCLUDE_HACKED_CODE_SEGMENTS_EXPLAIN', 'Enter any code segments that you would like the files searhed for by entering 

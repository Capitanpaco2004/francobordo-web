<form method="post" action="<?php echo tep_href_link($sUrlPage, 'action=account_2fa_disable') ?>" id="mainForm">
<div class="oeBox column a12 row ax">
	<div class="oeWrpr">
		<div class="oeTitu"><i class="fas fa-shield-xmark" style="color: #e74c3c;"></i> <?php echo TEXT_2FA_DISABLE_TITLE ?></div>
		<div class="oeCntd row ax xform xform-horizontal">
			<p style="margin-bottom: 20px;"><?php echo TEXT_2FA_DISABLE_INTRO ?></p>

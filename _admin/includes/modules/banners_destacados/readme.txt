Módulo banners destacados: Instalación
-------
...
```php
	(defined( 'BANNERS_DESTACADOS_ACTIVE' ) && BANNERS_DESTACADOS_ACTIVE == 'true' ? '<a href="' . tep_href_link('banners_destacados.php', '', 'NONSSL') . '" class="menuBoxContentLink2">Banners destacados</a>' : '') 
```

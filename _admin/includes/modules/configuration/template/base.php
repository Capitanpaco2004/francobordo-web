...
?>
	...
	<div class="oeHead column a12 row ax amiddle">
		<div class="oeTitu column a05 logo" style="padding-left: 55px;"><b><i style="top: 23px; left: 4px; font-size: 45px; line-height: 45px;" class="far fa-cog"></i><?php echo $sTitle; ?></b><?php echo ($sSubtitle ? '<small>' . $sSubtitle . '</small>' : ''); ?></div>

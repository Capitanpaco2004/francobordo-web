!function ($){
	...
	$(".form-admin-members .add-right").click(function () {
	...
	// Quitar selecionados
	$(".form-admin-members .add-left").click(function () {
		let selectLeft = $(this).parent().prev().find("select");
		let selecRight = $(this).parent().next().find("select");
	...
	// Insertar todos
	$(".form-admin-members .add-all-right").click(function () {
		$(this).parent().prev().find("select").find('option:not(.hidden)').prop('selected', true);
		$(".form-admin-members .add-right").trigger("click");
	});

	// Quitar todas
	$(".form-admin-members .add-all-left").click(function () {
		$(this).parent().next().find("select").find('option:not(.hidden)').prop('selected', true);
		$(".form-admin-members .add-left").trigger("click");
	});

	// Doble click
	$(".form-admin-members select").on("dblclick", "option", function()
	{
	...
	// Formularios
	$(".form-admin-members").submit(function(){

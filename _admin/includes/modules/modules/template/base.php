...
<div class="oeHead column a12 row ax amiddle">
	<div class="oeTitu column a05 logo" style="padding-left: 55px;"><b><i class="fas fa-puzzle-piece"></i><?php echo $sTitle; ?></b><?php echo ($sSubtitle ? '<small>' . $sSubtitle . '</small>' : ''); ?></div>

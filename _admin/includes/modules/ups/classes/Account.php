...
class Account {
	...
	public function save(){
		...
		if($this->id_ups_account){
			...
			//insert
			$result = tep_db_query("INSERT INTO `ups_account` (account_name, account_number, shipper_name, shipper_attention_name, dni_number, phone_number, address_line_1, address_line_2, id_country, state, city, postal_code, is_ups_ape, date_add, date_upd) 
				VALUES (
					'".	$this->account_name."',
					'".$this->account_number."',
					'".$this->shipper_name."',

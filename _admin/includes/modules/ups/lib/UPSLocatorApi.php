...
class UPSLocatorApi extends UPSBaseApi {
    ...
    public function findUPSAccessPoint($addressLine, $city, $postalCode, $countryCode, $maxListSize = "10", $searchRadius = "30", $distanceUnit = 'KM') {
            ...
            $searchRadius = min(intval($searchRadius),100);
            ...
            if ((string)$objResult->Response->ResponseStatusCode == '1') {
                ...
                if ($searchRadius < 100 && (string)$objResult->Response->Error->ErrorCode == '350201') {
                    $searchRadius += 10;
                    return $this->findUPSAccessPoint($addressLine,$city, $postalCode, $countryCode, $maxListSize, $searchRadius, $distanceUnit);
                }
                return false;
            }
    }

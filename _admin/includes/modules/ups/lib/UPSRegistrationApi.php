...
class UPSRegistrationApi extends UPSBaseApi
{
    ...
    public function doRegistration(
        ...
        $this->userId = base64_decode("QUdFTkNFVzM2MA==");
        $this->accessKey = base64_decode("N0NGNzVGRDdCRDc1QTc3NQ==");
        $this->passwd = base64_decode("KlVQUyo3Nzcq");
    ...
    public function doAddAccount(
        ...
        return $this->possibleResponses[(string)(isset($response->ShipperAccountStatus->Code) ? $response->ShipperAccountStatus->Code : $response->ShipperAccountStatus[0]->Code)];
    }

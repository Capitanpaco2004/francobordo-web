...
// Print the Option Name
        ...
        echo "<TD class=\"dataTableHeadingContent\"><B>Valor del precio</B></TD>";
        echo "<TD class=\"dataTableHeadingContent\"><B>Prefijo</B></TD>";
        
        if ( $optionTypeInstalled == "1" ) {
                
                echo "<TD class=\"dataTableHeadingContent\"><B>Opciones Type</B></TD>";
                echo "<TD class=\"dataTableHeadingContent\"><B>Cantidad</B></TD>";
                echo "<TD class=\"dataTableHeadingContent\"><B>Pedido</B></TD>";
                echo "<TD class=\"dataTableHeadingContent\"><B>Link Attr.</B></TD>";
        ...
        if ( $optionSortCopyInstalled == "1" ) {
                ...
                echo "<TD class=\"dataTableHeadingContent\"><B>Peso</B></TD>";
                echo "<TD class=\"dataTableHeadingContent\"><B>Peso Prefix</B></TD>";
                echo "<TD class=\"dataTableHeadingContent\"><B>Ordenar</B></TD>";
...
// Find all of the Current Option's Available Values
        ...
        $result2 = tep_db_query($query2) or die(tep_db_error());
        ...
        if ($matches2) {
           ...
           while ($line = tep_db_fetch_array($result2)) {
                ...
                $result3 = tep_db_query($query3) or die(tep_db_error());

                while($line = tep_db_fetch_array($result3)) {
...
// Add Support for multiple text input option types (for Chandra's contribution).. and using ' to begin/end strings.. less of a mess.
          ...
          echo "<TR>";
          echo "<TD class=\"main\"><SMALL>No hay valores definidos para esta opción.</SMALL></TD>";
          echo "</TR>";

...
<?php
  $products_query_raw = "select pd.products_id, pd.products_name, p.products_date_available from " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS . " p where p.products_id = pd.products_id and p.products_date_available != '' and p.products_date_available != '0000-00-00 00:00:00' and pd.language_id = '" . (int)$languages_id . "' order by p.products_date_available DESC";

...
<br><br><br>
<h3>
	<?php echo idioma("Connexion QFACWIN - osCommerce realitzada correctament.", "Conexi�n QFACWIN - osCommerce realizada correctamente.", "QINVOICING - osCommerce connection successfully completed") ?>
</h3>
<br>

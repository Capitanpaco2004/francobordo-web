...
//
  //chdir('/var/www/oscommerce-2.2ms2/catalog/admin');
	//chdir('C:\xampp\htdocs\catalog\admin');
  $language = 'espanol';
...
// Application  
  ...
  echo $rcs->getInfoBox();
  // Email informativo
mail( 'f.rodriguez@francobordo.com', '[CORRECTO] Recuperador de Carritos', 'Se ha actualizado con exito la tienda Francobordo.', 'MIME-Version: 1.0' . "\r\n" . 'Content-type: text/plain; charset=UTF-8' . "\r\n" . 'From:info@francobordo.com' . "\r\n" );

...
<?php
          ...
          $model_html_table.="                  <tr class=\"dataTableRowSelected\"><td class=\"smalltext\" colspan=\"" . (isset( $products_options_array ) ? sizeof($products_options_array) : '') . "\">&nbsp;</td></tr>\n";
          $quantity_html_table="               <table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"2\">\n";
          $quantity_html_table.="                  <tr class=\"dataTableRowSelected\"><td class=\"smalltext\" colspan=\"" . (isset( $products_options_array ) ? sizeof($products_options_array) : '') . "\">&nbsp;</td></tr>\n";
          $price_html_table="                <table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"2\">\n";
          $price_html_table.="                  <tr class=\"dataTableRowSelected\"><td class=\"smalltext\" colspan=\"" . (isset( $products_options_array ) ? sizeof($products_options_array) : '') . "\">&nbsp;</td></tr>\n";

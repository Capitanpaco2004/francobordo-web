...
/*
      ...
      Modifications made:
        ...
        03/2005 - Revertido a $_SERVER (migrado a superglobales modernas PHP 8.4)
...
<?php
  ...
  if ($flag) {
    ...
    echo "<td class=\"dataTableHeadingContent\"><span class=smalltext>Cantidad</span></td>";
    echo "</tr>";
    ...
    $i=1;
    echo "<td class=dataTableHeadingContent>Cantidad: </td>";
  }
...
<tr valign="top">
	<td class="dataTableHeadingContent" width="400" style="font-size: 12;">Stock por Atributos</td>
	<td class="dataTableHeadingContent" style="font-size: 12;">Links</td>
	
</tr>

<tr valign="top">
	<td class="menuBoxHeading" width="400" style="background-color:#FFF">
    ...
    <td class="menuBoxHeading" style="background-color:#FFF">
	<?php 
	
	
	echo '<br><ul><li><a href="' . tep_href_link(FILENAME_CATEGORIES, 'pID=' . $VARS['product_id'] . '&action=new_product') . '" class="menuBoxContentLink">Editar este producto</a></li>';

...
?>
		...
		<?php
			...
			$aUniForm = array( 'rma.php', 'create_order.php', 'create_account.php', 'refund_methods.php', 'return_product.php', 'return_text.php', 'returns.php', 'returns_invoice.php', 'returns_packingslip.php', 'returns_reasons.php', 'returns_status.php', 'feedmachine_admin.php', 'ExU.php', 'ExU_CDBARCOS.php', 'specialsbycategory.php', 'products_specifications.php', 'kiala_orders.php', 'stats_products_orders.php', 'customers_groups.php', 'stats_ad_results.php', 'stock.php', 'stats_recover_cart_sales.php', 'xsell.php', 'support_status.php', 'exportador.php', 'importador.php', 'support_priority.php', 'support_department.php', 'support_admin.php', 'faq.php', 'news2.php', 'support.php', 'optional_related_products.php', 'mail.php', 'premade_comments.php', 'quick_updates.php', 'edit_orders.php', 'reviews.php', 'amenddb.php', 'easypopulate.php', 'mail.php', 'stats_monthly_sales.php', 'stats_sales.php', 'coupons.php', 'coupons_exclusions.php', 'orders_check.php', 'products_multi.php', 'specials_avanzado.php', 'newsletters.php', 'specials.php', 'featured.php', 'products_home.php', 'edit_orders_add_product.php', 'ups_configure.php' );

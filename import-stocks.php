...
if (!file_exists( $sServer . '/descargas/stocks.xlsx' )) {
...
$aPHPobj = \PhpOffice\PhpSpreadsheet\IOFactory::load($sServer . '/descargas/stocks.xlsx');
$aSheetsNames = $aPHPobj->getSheetNames( $sServer . '/descargas/stocks.xlsx' );

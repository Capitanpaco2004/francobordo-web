...
if (($email_address != "") && ($password != "")) {
  $check_customer_query = tep_db_query("select customers_group_id, customers_specific_taxes_exempt, customers_id, customers_firstname, customers_lastname, customers_password, customers_email_address, customers_default_address_id from " . TABLE_CUSTOMERS . " where customers_email_address = '" . tep_db_input($email_address) . "'");
  if (tep_db_num_rows($check_customer_query)) {
    ...
    if (tep_validate_password($password, $check_customer['customers_password'])) {
	  ...
	  $sCustomersEmailAddress = $check_customer['customers_email_address'];
      ...
      if(!tep_session_is_registered('sCustomersEmailAddress'))

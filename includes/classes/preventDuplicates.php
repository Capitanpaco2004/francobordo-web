...
class preventDuplicates {
  ...
  public $getValues = array('sort', 'page', 'language', 'currency');
  public $IhaveDuplicateContent = true;
  public $turnServiceOn = true; // true turns on false will turn this service off
  public $meta;
  public $caught;
  public $addedMeta;
  public $finalMeta;
  public $noIndex = '<meta name="ROBOTS" content="NOINDEX, FOLLOW" />';

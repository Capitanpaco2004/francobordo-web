       ...
       if (isset($customer_id)) {
        ...
        if (isset($customer_id)) $cust_id=$customer_id;
                   ...
                   $current_page=addslashes(tep_db_input(urldecode($_SERVER['PHP_SELF'])));
                     ...
                     $refer_data = addslashes(tep_db_input(urldecode((string)($_SERVER['HTTP_REFERER'] ?? ''))));
...
//              $country_code = strtolower(geoip_country_code_by_addr($gi, $ip));
         ...
         $query = "INSERT INTO `supertracker` (`ip_address`, `browser_string`, `country_code`, `country_name`, `country_region`, `country_city`, `referrer`,`referrer_query_string`,`landing_page`,`exit_page`,`time_arrived`,`last_click`,`browser`) VALUES ('" . tep_db_input($ip) . "','" . tep_db_input($browser_string) . "','" . tep_db_input($country_code) . "', '" . tep_db_input($country_name) . "', '" . tep_db_input($region_name) . "', '" . tep_db_input($city_name) . "', '" . tep_db_input($referrer) . "', '" . tep_db_input($query_string) . "','" . $landing_page . "','" . tep_db_input($current_page) . "','" . $time_arrived . "','" . $time_arrived . "','" . tep_db_input(get_browser_($user_agent)) . "')";
                     tep_db_query($query);

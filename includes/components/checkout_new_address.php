...
<p class="campo city">
	<?php echo ajax_get_cities_html(false, false, false, false, true); 	?>
</p>
<?php
  if (ACCOUNT_STATE == 'true') {
?>
<p class="campo getCitiesFromZone"><label for="states"><?php echo ENTRY_STATE; ?></label><span id="states">
				<?php
				// +Country-State Selector
				echo ajax_get_zones_html(195,($entry['entry_zone_id'] == 0 ? $entry['entry_state'] : $entry['entry_zone_id']), false);
				// -Country-State Selector
				?>
				</span></p>                
<?php

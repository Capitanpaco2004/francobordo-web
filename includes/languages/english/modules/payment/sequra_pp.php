...
define('MODULE_PAYMENT_SEQURA_PP_TEXT_CONFIRMATION_TITLE',"<img src='".DIR_WS_MODULES."payment/SeQura/view/img/wo-120x30.png' alt='P&aacute;galo en 3, 6, o 12 cuotas *sin intereses*'/>P&aacute;galo en 3, 6, o 12 cuotas *sin intereses*. Desde %s/mes + %s por gastos de gesti&oacute;n");

...
//BOF Mobile
define('TEXT_INFORMATION_MOBILE', '<b>Please choose from one of the topics below:</b>');
//EOF Mobile

// Below is the section that will actually displax on the FAQ page
define('TEXT_INFORMATION2', '<a name="Top"></a><span class="pointWarning"><b>Please choose from one of the topics below:</b></span>');
?>
...
define('CART_ITEM', 'Products quantity :'); // azer for 2.20
  ...
  define('CART_SHIPPING_OPTIONS_LOGIN', 'Please <a href="' . tep_href_link(FILENAME_LOGIN, '', 'SSL') . '"><u>Log In</u></a>, to display your personal shipping costs.<br >&nbsp;<br >');
...
define('SHIPPING_ESTIMATOR_NO_OPTIONS_MESSAGE', 'Sorry. There is no shipping methods for this address.<br >Please, <a href="'.FILENAME_CONTACT_US.'">contact us </a> to find solutions to process and ship your order.');

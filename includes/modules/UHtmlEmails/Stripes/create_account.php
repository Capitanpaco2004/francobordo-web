							...
							<tbody>
								...
								<tr>
									<td colspan="2" style="padding: 35px 30px; font-size: 15px; font-family: Arial; letter-spacing: 0.2px; color: #5f5f5f; line-height: 24px;">
										...
										<br><br>
										' . str_replace( $ArrayLNTargets, '<br />', (!empty($bProfesional) && $bProfesional ? UHE_WELCOME_PROF : UHE_WELCOME) ) . '
										<table style="line-height: 20px; font-size: 15px; font-family: Arial; letter-spacing: 0.2px; color: #5f5f5f;" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td style="padding: 13px 23px; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4;">' . UHE_CARRITO2 . '</td>
											</tr>
											<tr>
												<td width="162" style="vertical-align: top; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; border-right: 1px solid #e4e4e4; padding: 13px 0 13px 16px; text-align: left;">
													<b>' . UHE_LIBRO . '</b>
												</td>
												<td style="padding: 13px 23px; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4;">' . UHE_LIBRO2 . '</td>
											</tr>
											<tr>
												<td width="162" style="vertical-align: top; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; border-right: 1px solid #e4e4e4; padding: 13px 0 13px 16px; text-align: left;">
													<b>' . UHE_HISTORIAL . '</b>
												</td>
												<td style="padding: 13px 23px; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4;">' . UHE_HISTORIAL2 . '</td>
											</tr>
											<tr>
												<td width="162" style="vertical-align: top; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; border-right: 1px solid #e4e4e4; padding: 13px 0 13px 16px; text-align: left;">
													<b>' . UHE_COMENTARIOS . '</b>
												</td>
												<td style="padding: 13px 23px; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4;">' . UHE_COMENTARIOS2 . '</td>
											</tr>
											<tr>
												<td width="162" style="vertical-align: top; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; border-right: 1px solid #e4e4e4; padding: 13px 0 13px 16px; text-align: left;">
													<b>' . UHE_PUNTOS . '</b>
												</td>
												<td style="padding: 13px 23px; border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4;">' . UHE_PUNTOS2 . '</td>
											</tr>
										</table>
										<br>
										' . UHE_RECORDAR . '<br>
										<table width="79%" align="center" style="line-height: 44px; font-size: 15px; font-family: Arial; letter-spacing: 0.2px; color: #5f5f5f	;" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td align="center">
													<span style="border-radius: 12px; background: #2bb0e2; display: block; font-size: 22px; line-height: 68px; font-weight: bold; height: 72px; width: 248px; color: #fff;">' . $password . '</span>
												</td>
											</tr>
										</table>
										<br><br>
								...
								<tr>
									<td colspan="2" style="border-top: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; padding: 32px 96px 97px;">
										<table border="0" cellspacing="0" cellpadding="0" style="font-family: Arial; font-size: 14px; font-style: italic; color: #fd6590; line-height: 20px; letter-spacing: -0.2px;">
											<tr>
												<td valign="top">
													<img width="16" height="14" border="0" src="' . HTTP_SERVER . DIR_WS_CATALOG . DIR_THEME . 'images/email/alert.jpg" style="display:block; padding-top: 2px; padding-right: 5px; border: 0;">
												</td>
												<td>
													<span>' . UHE_WARNING . '</span>
												</td>
											</tr>
										</table>
									</td>

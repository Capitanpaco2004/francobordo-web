<?php
require(DIR_FS_CATALOG . DIR_WS_LANGUAGES . $language . '/modules/UHtmlEmails/Standard/returns.php');
									...
									<td colspan="2" style="padding: 35px 0 25px; font-size: 15px; font-family: Arial; letter-spacing: 0.2px; color: #5f5f5f; line-height: 24px;">
										...
										<table style="font-family: Arial;" border="0" cellpadding="27" cellspacing="0">
											<tr style="color:#fff; font-weight:bold; font-size: 16px; line-height: 14px;">
												...
												<td align="center" width="614" bgcolor="#fa8d23">' . $orders_status_array[$status] . '</td>
											</tr>
										</table>
										<br>
										<table width="100%" style="line-height: 14px; font-size: 15px; font-family: Arial; letter-spacing: 0.2px; color: #23a2d1;" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td style="vertical-align: top; padding: 13px 30px 13px 30px; text-align: left;">
													' . UHE_TEXT_INVOICE_URL . '  <a href="<a href="' . tep_catalog_href_link(FILENAME_CATALOG_ACCOUNT_HISTORY_INFO, 'order_id=' . $updateOrder->info['order_id'], 'SSL') .'" style="color: #606060;">' . tep_catalog_href_link(FILENAME_CATALOG_ACCOUNT_HISTORY_INFO, 'order_id=' . $updateOrder->info['order_id'], 'SSL') .'</a>
												</td>
											</tr>
										</table>';
										if ($comments != '')
										...
										<table width="100%" style="line-height: 20px; font-size: 15px; font-family: Arial; letter-spacing: 0.2px; color: #23a2d1; padding: 12px 0 100px;" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td>
													<i style="color: #606060;">' . str_replace( $ArrayLNTargets, '<br />', $comments ) . '</i>
												</td>
											</tr>
										</table>';
										}

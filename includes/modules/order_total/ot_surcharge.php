...
class ot_surcharge {
	...
	public function __construct() {
		...
		$this->enabled     = defined('MODULE_PAYMENT_STATUS') && MODULE_PAYMENT_STATUS == 'true' ? MODULE_PAYMENT_STATUS : false;
		if ($this->enabled) {
	...
	public function calculate_fee($amount) {
		global $order, $customer_id, $payment;
		$od_amount = 0;
		//----------------------------------------------------------------------
		$od_pc = $this->percentage + .00; //this is percentage plus the base fee
		//----------------------------------------------------------------------
		$do = false;
	...
	public function keys() {
		return ['MODULE_PAYMENT_STATUS', 'MODULE_PAYMENT_SORT_ORDER', 'MODULE_PAYMENT_PERCENTAGE', 'MODULE_PAYMENT_MINIMUM', 'MODULE_PAYMENT_TYPE', 'MODULE_PAYMENT_INC_SHIPPING', 'MODULE_PAYMENT_INC_TAX', 'MODULE_PAYMENT_CALC_TAX'];
	}
}

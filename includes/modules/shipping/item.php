...
// class constructor
    function __construct() {
      ...
      $this->sort_order = defined( 'MODULE_SHIPPING_ITEM_SORT_ORDER' ) ? MODULE_SHIPPING_ITEM_SORT_ORDER : 99;
      $this->icon = '';
...
$envio = MODULE_SHIPPING_ITEM_TEXT_TITLE_2;
$envio_descripcion=MODULE_SHIPPING_ITEM_TEXT_WAY_2;
} else { 
if ($total_ship_count >1){
$envio = MODULE_SHIPPING_ITEM_TEXT_TITLE_3;
$envio_descripcion=MODULE_SHIPPING_ITEM_TEXT_WAY_2;
} else{
$envio= MODULE_SHIPPING_ITEM_TEXT_TITLE;
$envio_descripcion=MODULE_SHIPPING_ITEM_TEXT_WAY;
}}
if($total_ship_count==0){
      $this->quotes = array('id' => $this->code,
                            'module' =>$envio,
                            'methods' => array(array('id' => $this->code,
                                                     'title' => $envio_descripcion ,

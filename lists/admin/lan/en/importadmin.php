...
'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'Test output:<br/>There should only be ONE email per line.<br/>If the output looks ok, go <a href="javascript:history.go(-1)">Back</a> to resubmit for real<br/><br/>',
'List for' => 'List for',
'login' => 'login',
);
?>
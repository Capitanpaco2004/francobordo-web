...
'After Database initialisation, you will receive an email with a token to set your login password.' => 'After Database initialisation, you will receive an email with a token to set your login password.',
'The initial <i>login name</i> will be' => 'The initial <i>login name</i> will be',
'Please enter the password you want to use for this account.' => 'Please enter the password you want to use for this account.',
'The initial <i>login name</i> will be\' ).\' "admin"\'.\'</p>\';
  }
  */
  ...
  if (!ENCRYPT_ADMIN_PASSWORDS) {
    */
    ...
    print \'<p>\'.$GLOBALS[\'I18N\']->get(\'Please enter the password you want to use for this account.' => 'The initial <i>login name</i> will be\' ).\' "admin"\'.\'</p>\';
  }
  */
  print \'<input type="text" name="adminemail" value="" size="25" /><br/>\';
  /*
  if (!ENCRYPT_ADMIN_PASSWORDS) {
    */
    print \'<p>\'.$GLOBALS[\'I18N\']->get(\'The initial <i>login name</i> will be\' ).\' "admin"\'.\'</p>\';
    print \'<p>\'.$GLOBALS[\'I18N\']->get(\'Please enter the password you want to use for this account.',
'minimum of 8 characters.' => 'minimum of 8 characters.',
'Hello' => 'Hello',
'You have requested a new password for phpList.' => 'You have requested a new password for phpList.',
);
?>
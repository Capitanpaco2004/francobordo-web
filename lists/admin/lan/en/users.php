...
'%s users in total' => '%s users in total',
'too many users, use a search query to list some' => 'too many users, use a search query to list some',
'rss freq' => 'rss freq',
'last sent' => 'last sent',
'Sorry, only super users can delete users' => 'Sorry, only super users can delete users',
);
?>